...
// Description: ADC_ETR的上升沿触发程序采样AN0口变阻器的AD值并计算其电压
//
// RELEASE HISTORY
...
void POWER_INITIAL (void) 
{
	...
	PORTA = 0B00000000;		
	TRISA = 0B00010001;		//PA输入输出 0-输出 1-输入
	PORTB = 0B00000000;		
...
void ADC_INITIAL(void) 
{
	...
	ADCON0 = 0B00000100; 	//选择AD转换通道0，ADC_ETR触发ADC
    ...
    ADCON2 = 0B01010101; 	//选择内部正参考电压2V，ADC_ETR上升沿触发
