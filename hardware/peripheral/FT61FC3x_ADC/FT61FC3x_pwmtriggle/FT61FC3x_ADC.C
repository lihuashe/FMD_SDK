...
// Description: PWM P1A0的上升沿触发程序采样AN0口变阻器的AD值并计算其电压
//
// RELEASE HISTORY
...
void ADC_INITIAL(void) 
{
	...
	ADCON0 = 0B00000100; 	//选择AD转换通道0，PWM触发ADC
    ...
    ADCON2 = 0B01010000; 	//选择内部正参考电压2V，P1A0上升沿触发
...
{    
    T2CON0 = 0B00000011;               //Bit[6:3]=TOUTPS  后分频比	0000=1:1~1111=1:16
                                       //Bit2=TMR2ON	   1=TIMER2打开	0=关闭
                                       //Bit[1:0]=T2CKPS  预分频比 00=1:1 01=1:4 1x=1:16
                                                    
        
    T2CON1 = 0B00000000;            //时钟源为2xHIRC
	...
	P1OE=0B00000001;        // Bit7=P1C0OE	1=P1C0输出到PB2	 0=不输出
