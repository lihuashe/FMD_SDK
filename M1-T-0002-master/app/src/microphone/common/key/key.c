...
void key_scan()
{
    ...
    static u16 key_press_counter = 0;
    ...
    if (cur_key == last_key) {                          //长时间按键
        ...
        else if (key_press_counter == KEY_LONG_STRAT_CNT) {
             key_puts(" KEY_LONG_STRAT ");
            key_status = KEY_LONG_STRAT;
        }
        ...
        last_key = cur_key;
        if ((key_press_counter > KEY_SHORT_CNT) && (key_press_counter < KEY_LONG1_CNT) && (cur_key == NO_KEY)) {   //短按抬起
            key_press_counter = 0;
            key_status = KEY_SHORT_UP;
        } else if ((key_press_counter > KEY_LONG1_CNT) && (key_press_counter < KEY_LONG_CNT) && (cur_key == NO_KEY)) { //长按抬起
            key_press_counter = 0;
            key_status = KEY_LONG1_UP;
            //key_puts(" key_status = KEY_LONG1_UP \n");
