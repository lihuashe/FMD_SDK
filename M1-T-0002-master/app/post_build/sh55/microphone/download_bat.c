...
cd ..\app\post_build\sh55\microphone
isd_download.exe -tonorflash -dev sh55 -boot 0x0 -div8 -wait 300 -uboot uboot.boot  -uboot_compress -app ..\..\..\..\build\app.bin \
-res  dir_notice -key AD15N-50B2-63357552.lkey

// dir_a dir_song dir_eng dir_notice 
@rem  ::-key AD15N-50B2-63357552.lkey


@rem isd_download.exe -tonorflash -dev sh55 -boot 0x0 -div8 -wait 300 -uboot uboot.boot  -uboot_compress -app app.bin 0x15000 \
@rem -res  dir_song dir_eng dir_poetry  dir_notice dir_midi midi_cfg 
